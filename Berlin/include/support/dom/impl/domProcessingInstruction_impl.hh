...
#ifndef __DOMPROCESSINGINSTRUCTION_IMPL__
#define __DOMPROCESSINGINSTRUCTION_IMPL__

class domProcessingInstruction_impl : virtual public Node
{
    virtual wstring * name(void);
    virtual void name(const wstring & _value);
    virtual wstring * data(void);
    virtual void data(const wstring & _value);
};

#endif //__DOMPROCESSINGINSTRUCTION_IMPL__
