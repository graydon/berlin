;; $Id: dbsect.dsl,v 1.1 1999/08/20 09:13:57 gray Exp $
;;
...
(define ($section-hlevel$ #!optional (sectname (gi))) 
  (cond
   ((equal? sectname (normalize "sect1")) 1)
   ((equal? sectname (normalize "sect2")) 2)
   ((equal? sectname (normalize "sect3")) 3)
   ((equal? sectname (normalize "sect4")) 4)
   ((equal? sectname (normalize "sect5")) 5)
   ((equal? sectname (normalize "refsect1")) 2)
   ((equal? sectname (normalize "refsect2")) 3)
   ((equal? sectname (normalize "refsect3")) 4)
