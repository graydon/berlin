;; $Id: dbcallou.dsl,v 1.1 1999/08/20 09:13:56 gray Exp $
;;
...
(define ($callout-linespecific-content-with-linenumbers$)
...
(define ($callout-linespecific-content$)
...
(define ($callout-verbatim-display$ line-numbers?)
  (let* ((width-in-chars (if (attribute-string "width")
    ...
    (make paragraph
	  ...
	  quadding: 'start
	  (if line-numbers?
	      ($callout-linespecific-content-with-linenumbers$)
	      ($callout-linespecific-content$)))))
