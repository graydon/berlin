...
(define usen-refentry-name      "&RefEntry;")
(define usen-reference-name	"&Reference;")
(define usen-refname-name	"&RefName;")
(define usen-revhistory-name	"&RevHistory;")
(define usen-refsect1-name      "&RefSection;")
(define usen-refsect2-name      "&RefSection;")
(define usen-refsect3-name      "&RefSection;")
...
(define (gentext-usen-element-name gind)
  (let* ((giname (if (string? gind) gind (gi gind)))
    ...
    (cond
     ...
     ((equal? name (normalize "refentry"))	usen-refentry-name)
     ...
     ((equal? name (normalize "refsect1"))	usen-refsect1-name)
     ((equal? name (normalize "refsect2"))	usen-refsect2-name)
     ((equal? name (normalize "refsect3"))	usen-refsect3-name)
