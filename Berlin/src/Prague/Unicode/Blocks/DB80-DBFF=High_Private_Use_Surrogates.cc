/*
 * Plugin for Unicode Block "High Private Use Surrogates"
 * (DB80-DBFF)
 * Unicode Version: 3.0
 *
...
namespace Unicode {
  ...
  class High_Private_Use_Surrogates : public Unicode::Dictionary::Block {
  public:
    void clean() {
    };
...
dload(Unicode::High_Private_Use_Surrogates);
